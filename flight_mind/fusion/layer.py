...
def fuse(
    ...
    """
    4-Tier Bayesian Confluence Fusion.

    confluence_signed = w1·T1 + w2·T2 + w3·T3 + w4·T4   ∈ [-1, +1]
    confluence_score  = |confluence_signed|              ∈ [0, +1]
    direction         = sign(confluence_signed)
    """
    tier_outputs = {"T1": t1, "T2": t2, "T3": t3, "T4": t4}
    ...
    signed = (
        ...
        + FUSION.w_tier3_microstr * _to_signed(t3)
